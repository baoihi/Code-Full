...
// @version 4.1
// @description Menu điều khiển - Tự động đăng nhập từ thẻ h3.rs
// @author YourName
// @match *://*/*
...
(function() {
        ...
        if (loginBtn) {
            loginBtn.onclick = function() {
                ...
                if (username) {
                    ...
                    if (typeof GM_notification === 'function') {
                        GM_notification({ text: 'Không tìm thấy thông tin đăng nhập! Hãy vào web có <h3 class="rs">username</h3>', title: 'Lỗi', timeout: 3000 });
                    } else {
                        alert('Không tìm thấy thông tin đăng nhập! Hãy vào web có thẻ <h3 class="rs">username</h3>');
                    }
                }
            };
        }
    ...
    async function init() {
        ...
        console.log('%c🎯 Control Panel v4.1 - Tự động đăng nhập từ h3.rs!', 'color: #0f0; font-size: 14px');
        console.log('%c👆 Click vào nút tròn để mở menu', 'color: #ffd700;');
        console.log('%c🔑 Đăng nhập tự động khi có <h3 class="rs">username</h3>', 'color: #00adb5;');
