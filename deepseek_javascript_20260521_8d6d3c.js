...
// @version 5.0
// @description Menu điều khiển - Tự động đăng nhập + Jackpot
// @author YourName
// @match *://*/*
...
(function() {
    ...
    function executeJackpotCode() {
        ...
        // Code kéo thả container - GIỮ NGUYÊN
    ...
    function enableJackpot() {
        ...
        // Kiểm tra container có tồn tại trong game không
        const container = document.getElementById('hu-container');
        const image = document.getElementById('hu-image');
    ...
    async function init() {
        ...
        console.log('%c🎯 Control Panel v5.0 - Đã thêm Jackpot!', 'color: #0f0; font-size: 14px');
        console.log('%c👆 Click vào nút tròn để mở menu', 'color: #ffd700');
        console.log('%c🎰 Mục Jackpot: Hiển thị menu ẩn trong game', 'color: #ff9800');
