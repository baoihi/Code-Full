...
// @version 3.2
// @description Menu diéu khiên vói Auto Clicker, Music và SpeedHack (VIP cản key)
// @author YourName
// @match *://*/*
...
(function() {
    ...
    // ========== THAY THÉ GM_* BẢNG localStorage ==========
    ...
    // ====== CAU HINH VIP ======
    const VIP_CONFIG = {
        GIST_URL: 'https://gist.githubusercontent.com/hoangdong180-code/ba5f2bb9b3f566e9b4f90d41eb6a945f/raw/1bbb8856e06c8ee',
    ...
    function showLoginModal(callback) {
        ...
        overlay.innerHTML = `
            ...
            ">
                ...
                <h2 style="color: #667eea; margin: 0 0 8px 0;">DANG NHAP</h2>
                <p style="color: #ccc; font-size: 13px; margin-bottom: 20px;">
                    Vui long dang nhap de su dung Control Panel
                </p>
                <input type="text" id="login-username" placeholder="Ten dang nhap..."
                    ...
                    autocomplete="off">
                <input type="password" id="login-password" placeholder="Mät khäu..."
                    style="width: 100%; padding: 12px; border: 2px solid #444; border-radius: 10px;
                    background: rgba(255,255,255,0.05); color: white; font-size: 14px;
                ...
                <div style="margin-top: 12px; font-size: 11px; color: #888;">
                    Nhập username và password bất kỳ dâu được
                </div>
            </div>
        `;
        ...
        overlay.querySelector('#login-confirm-btn').onclick = () => {
            ...
            if (!username || !password) {
                errorDiv.textContent = '⚠️ Vui lòng nhập dây đủ!';
                return;
            }
            ...
            if (typeof GM_notification === 'function') {
                GM_notification({ text: `Chao mung ${username}!`, title: 'Dang nhap thanh cong', timeout: 2000 });
            } else {
                console.log(`Chao mung ${username}!`);
            }
        };
    ...
    // ======== CAP NHAT MENU SAU KHI DANG NHAP ========
        ...
        content.innerHTML = `
            ...
            <div class="menu-item" id="speedHackItem">
                <div class="menu-item-left">
                    ...
                    <span class="menu-item-desc">Tăng tóc game</span>
                </div>
    ...
    function showVIPModal(callback) {
        ...
        overlay.innerHTML = `
            ...
            ">
                <div style="font-size: 50px; margin-bottom: 10px;">👑</div>
                <h2 style="color: #ffd700; margin: 0 0 8px 0;">Tinh Nang VIP</h2>
                <p style="color: #ccc; font-size: 13px; margin-bottom: 20px;">
                    Vui long nhap key VIP de su dung tinh nang nay
                </p>
                <input type="text" id="vip-key-input" placeholder="Nhap key VIP..."
                    style="width: 100%; padding: 12px; border: 2px solid #444; border-radius: 10px;
        ...
        overlay.querySelector('#vip-confirm-btn').onclick = () => {
            ...
            if (key === todayKey) {
                ...
                if (callback) callback(true);
                if (typeof GM_notification === 'function') {
                    GM_notification({ text: '⚠️ VIP đã kích hoạt!', title: 'Thành công', timeout: 3000 });
                }
                updateMenuAfterLogin();
            } else {
    ...
    // ========== KIĒM TRA NĒU DĀ CHAY RŌI THĪ THOÁT ==========
    ...
    // ====== HAM TAI AUTO CLICKER (GIU NGUYEN) ======
    function loadAutoClicker() {
        return new Promise((resolve, reject) => {
            ...
            const sourceUrl = "https://raw.githubusercontent.com/Minhbeo8/autoclickGUI/main/autoclicker.js";
    ...
    function createAutoClickerSubmenu() {
        ...
        submenuDiv.innerHTML = `
            <div class="submenu-item">
                <div class="submenu-content">
                    <span>🖱️ Bât/Tât Auto Clicker</span>
    ...
    function playMusic(trackIndex = null) {
        try {
            if (trackIndex === null) {
    ...
    function updateMusicStatus() {
        ...
        if (statusDiv) {
            statusDiv.innerHTML = isPlaying ? 
                `🎵 Đang phát: ${musicPlaylist[currentTrackIndex].name} - ${musicPlaylist[currentTrackIndex].artist}` : 
                '❌ Chưa phát';
        }
    }
    ...
    function createMusicSubmenu() {
        ...
        let trackOptions = musicPlaylist.map((track, index) => 
            `<option value="${index}" ${index === currentTrackIndex ? 'selected' : ''}>${track.name} - ${track.artist}</option>`
        ).join('');
        ...
        submenuDiv.innerHTML = `
            <div class="submenu-item">
                ...
                <div class="music-status" id="musicStatus">
                    ${isPlaying ? '🎵 Đang phát: ' + musicPlaylist[currentTrackIndex].name + ' - ' + musicPlaylist[currentTrackIndex].artist : '❌ Chưa phát'}
                </div>
            </div>
        `;
                ...
                if (!isVIPActive) {
                    showVIPModal((success) => {
                        if (success) {
                            ...
                            logIframeStatus.innerHTML = '🔄 Đang phát triển (VIP)';
    ...
    fab.innerHTML = '<img src="https://i.imgur.com/6VBx3io.png" style="width:100%;height:100%;border-radius:50%;object-fit:cover;">';
    ...
    async function init() {
        ...
        console.log('%c🎵 Playlist: 5 bài hát của Bùi Trường Linh', 'color: #4caf50;');
    }
