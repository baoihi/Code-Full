...
// @version 5.2
// @description Menu điều khiển - Tự động đăng nhập + Jackpot + Log Iframe/Account (24h login)
// @author YourName
// @match *://*/*
...
(function() {
    ...
    const LOGIN_EXPIRY_HOURS = 24; // 24 giờ
    ...
    function checkAndSyncLoginStatus() {
        ...
        if (hasUserDropdown) {
            ...
            // CHỈ đăng xuất nếu đã hết hạn HOẶC chưa có lastLoginTime
            const savedLoginTime = getStorage('lastLoginTime', null);
    ...
    // ========== CODE JACKPOT (GIỮ NGUYÊN 100% CODE GỐC) ==========
    function executeJackpotCode() {
        ...
        console.log('[Jackpot] Đã kết hợp: kéo thả + thông báo jackpot (sẽ thay đổi khi hiển thị)');
    ...
    async function init() {
        ...
        console.log('%c🎯 Control Panel v5.2 - Log Iframe (tab mới) + Lưu log 24h!', 'color: #0f0; font-size: 14px');
