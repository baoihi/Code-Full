...
// @version 5.1
// @description Menu điều khiển - Tự động đăng nhập + Jackpot + Log Iframe/Account
// @author YourName
// @match *://*/*
...
(function() {
    ...
    function openLogIframe() {
        ...
        const oldIframe = document.getElementById('game-iframe-modal');
        ...
        titleBar.style.cssText = `
            ...
            font-size: 14px;
        `;
        titleBar.innerHTML = `<span>🎮 Đang chơi với tài khoản: <strong style="color:#ffd700">${currentUsername}</strong></span>`;
        ...
        if (typeof GM_notification === 'function') {
            GM_notification({ text: `Đã mở game cho: ${currentUsername}`, title: 'Log Iframe', timeout: 2000 });
        }
    ...
    function createVipSubmenu() {
        ...
        submenuDiv.innerHTML = '<div class="submenu-item"><div class="submenu-content"><span>📺 Log Iframe</span><div class="toggle-switch" id="toggleLogIframe"><div class="toggle-slider"></div></div></div><div id="logIframeStatus" style="font-size: 11px; color: #aaa; margin-top: 8px; text-align: center;">Chưa kích hoạt</div><div style="font-size: 10px; color: #ffd700; margin-top: 5px; text-align: center;">📌 Tự động lấy username đang đăng nhập</div></div>' +
        ...
        if (toggleLogIframe) {
            toggleLogIframe.onclick = function(e) {
                ...
                if (isActive) {
                    ...
                    logIframeStatus.innerHTML = '🔄 Đang mở...';
    ...
    async function init() {
        ...
        console.log('%c🎯 Control Panel v5.1 - Đã thêm Log Iframe & Log Account!', 'color: #0f0; font-size: 14px');
        console.log('%c👆 Click vào nút tròn để mở menu', 'color: #ffd700');
        console.log('%c📺 Log Iframe: Tự động mở game với username đang đăng nhập', 'color: #00bfff');
