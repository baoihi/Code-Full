...
(function() {
            ...
            GM_xmlhttpRequest({
                ...
                onload: function(r) {
                    try {
                        ...
                        const cache = GM_setValue('keyCache', '{}');
    ...
    document.querySelectorAll(
        ...
        '#floatingNotification, #vip-modal-overlay'
    ).forEach(el => {
    ...
    function createVipSubmenu() {
        ...
        // Toggle Log Iframe - KHÔNG cần VIP
        ...
        // Toggle Log Account - CÓ VIP BADGE -> CẦN KEY
    ...
    async function init() {
        ...
        console.log('%c✅ Control Panel v3.2 đã sẵn sàng!', 'color: #0f0; font-size: 14px');
        console.log('%c👑 Tính năng có logo VIP cần nhập key để dùng', 'color: #ffd700;');
    }
